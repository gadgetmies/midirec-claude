...
**Body row** — `.mr-param-lane__body` SHALL span the lane's full width and SHALL be `display: flex; align-items: stretch; height: var(--mr-h-param-lane)`. It contains two children:
